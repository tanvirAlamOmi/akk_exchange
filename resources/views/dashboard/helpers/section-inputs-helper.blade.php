    ...
    <div class="row mb-3">
            ...
            <ul class="list-group section-entry-list" id="article">
                ...
                <li class="list-group-item">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label fw500 text-dark" for="articleCoverImage"><span class="text-primary">Image</span></label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input property" value="textVideo" id="articleVideo" name="property[]">
                        <label class="custom-control-label fw500 text-dark" for="articleVideo"><span class="text-primary">Video</span></label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input property" value="textFile" id="articleFile" name="property[]">
                        <label class="custom-control-label fw500 text-dark" for="articleFile"><span class="text-primary">File</span></label>
                    </div>
                    <div class="custom-control custom-checkbox">
        ...
        <div class="col-md-4 col-sm-2 mb-3">
            <ul class="list-group section-entry-list" id="msWord">
                <li class="list-group-item pt-2">
                    <label class="input-container mb-0 fw500">MS Word Copy & Pase
