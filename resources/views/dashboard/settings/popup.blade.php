...
@section('dashboard_content')
	...
	<div class="container-fluid">        
        <div class="card mb-4">
            ...
            @if (!empty($popup['is_active']))
                <h5 class="text-success ms-auto">Running</h5>
            @endif
        </div>
            <div class="card-body">
                            ...
                            <div class="row mb-0">
                                <div class="col-md-12">
                                    <div class="d-grid gap-2">
                                        ...
                                        @if (isset($popup['is_active']))
                                            <a href="#" class="btn btn-sm btn-danger change-confirmation" title="Delete"  data-id="delete"
                                                data-request-url="{{ action([\App\Http\Controllers\Dashboard\DashboardController::class, 'popupUpdate'] ) }}"  
                                                data-redirect-url="{{ action([\App\Http\Controllers\Dashboard\DashboardController::class, 'popupEdit']) }}"
                                                data-title = "delete"
