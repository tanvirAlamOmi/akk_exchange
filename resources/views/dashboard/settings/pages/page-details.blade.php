                    ...
                    <div class="row mt-2 mb-5">
                        ...
                        <div class="row">
                            ...
                            @if($section->type == 'imageSlider')
                                ...
                                @include('dashboard.contents.image-contents.contents')

                                <!-- <hr class="heading-devider mt-2"> -->

                            @elseif($section->type == 'article')

                                @include('dashboard.contents.text-contents.contents')
                            ...
                            @elseif($section->type == 'groupContent')
                                ...
                                @if(strtolower(getGroupContentType($section->property)) == 'video')
                                    ...
                                    @include('dashboard.contents.video-contents.contents')
                                ...
                                @if(strtolower(getGroupContentType($section->property)) == 'file')
                                    ...
                                    @include('dashboard.contents.file-contents.contents')
                            ...
                            @elseif($section->type == 'dataContent')
                                ...
                                @include('dashboard.contents.data-contents.contents')
