...
class PageController extends Controller
{
    ...
    {
        $editRow = '';
        $page = Page::select('id','type','title','subtitle','image','meta_keywords','meta_description','status')->with(['sections.image_contents','sections.text_contents','sections.file_contents','sections.video_contents'])->find($id);
